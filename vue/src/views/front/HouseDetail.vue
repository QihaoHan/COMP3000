    ...
    <div style="display: flex; gap: 20px">
      ...
      <div style="flex: 1">
        <div style="margin: 20px 0; display: flex; align-items: center">
          ...
          <div style="color: #666; font-size: 13px">{{ nurseHouse.count }} views</div>
        </div>
        ...
        <div style="display: flex; margin: 10px 0;">
          <div style="width: 200px"><span style="color: #666">Institution Nature:</span>{{ nurseHouse.nature }}</div>
          <div style="flex: 1"><span style="color: #666">Institution Type:</span>{{ nurseHouse.type }}</div>
        </div>
        <div style="display: flex; margin: 10px 0;">
          <div style="width: 200px"><span style="color: #666">Establishment Date:</span>{{ nurseHouse.date }}</div>
          <div style="flex: 1"><span style="color: #666">Number of Beds:</span>{{ nurseHouse.beds }}</div>
        </div>
        <div style="display: flex; margin: 10px 0;">
          <div style="width: 200px"><span style="color: #666">Facility Area:</span>{{ nurseHouse.area }}</div>
        </div>

        <div style="margin: 20px 0">
          Phone:<span style="font-size: 20px; font-weight: bold; color: orangered">{{ nurseHouse.phone }}</span>
        </div>
      </div>
    </div>

    <div style="margin: 30px 0">
      <div style="font-weight: bold; font-size: 22px; text-align: center; margin-bottom: 30px"></div>
