<template>
  <div>
    <el-card style="width: 50%">
      <el-form :model="user" label-width="250px" style="padding-right: 50px">
...
export default {
  ...
  methods: {
    update() {
      ...
      this.$request.put('/admin/update', this.user).then(res => {
        if (res.code === '200') {
          ...
          // Update user information in browser storage
    ...
    handleAvatarSuccess(response, file, fileList) {
      // Update user's avatar property to the uploaded image's URL
