<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter user name to search" style="width: 200px" v-model="userName"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="activityId" label="Activity ID"></el-table-column>
        ...
        <el-table-column prop="userId" label="Registrant ID"></el-table-column>
        <el-table-column prop="userName" label="Registrant"></el-table-column>
        <el-table-column prop="status" label="Approval Status"></el-table-column>
        <el-table-column prop="reason" label="Approval Comments"></el-table-column>
    ...
    <el-dialog userName="Audit Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="250px" style="padding-right: 50px" :model="form" ref="formRef">
        <el-form-item prop="userName" label="Approval Status">
          <el-radio-group v-model="form.status">
            <el-radio label="Approved"></el-radio>
            <el-radio label="Rejected"></el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item prop="reason" label="Approval Comments">
...
export default {
  ...
  methods: {
    handleAdd() {   // Add data
      this.form = {}  // Clear form when adding
      this.fromVisible = true   // Open the dialog
    },
    handleAudit(row) {   // Audit data
